...
export const fetch = (brainstemKey, modelId, options = {}) => {
  const {
    fetchOptions = {},
    postFetchAction,
    preFetchAction,
...
export const save = (brainstemKey, modelId, attributes, options = {}) => {
  const {
    saveOptions = {},
    preSaveAction,
    postSaveAction,
...
export const destroy = (brainstemKey, modelId, options = {}) => {
  const {
    deleteOptions = {},
    trackKey,
    adapter = defaultAdapter,
...
export const validate = (brainstemKey, attributes, options = {}) => {
  const {
    validateOptions = {},
    preValidateAction,
    postValidateAction,
